...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,		XK_m,	   spawn,	   {.v = (const char*[]){ "displays", NULL } } },
	...
	{ MODKEY,                       XK_bracketleft, spawn,     SHCMD("wpctl set-volume @DEFAULT_SINK@ 5%- && sigdwmblocks 2") },
	{ MODKEY,                       XK_bracketright, spawn,     SHCMD("wpctl set-volume @DEFAULT_SINK@ 5%+ && sigdwmblocks 2") },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
